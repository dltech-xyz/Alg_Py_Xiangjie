...
@LastEditors: steven
@LastEditTime: 2020-06-08 23:31:49
@Description:
'''
...
class string(single_list):
    ...
    def naive_matching(self, p):  #self为目标字符串，t为要查找的字符串
        ...
        i, j = 0, 0
        m, n = p.length(), self.length() # m,n = len(p),len(self) https://blog.csdn.net/weixin_40539952/article/details/104280148
